...
fixtures=(
  ...
  examples/testing/owned_field_move_test.mko
  ...
  examples/testing/struct_array_clone_rc_test.mko
  examples/testing/nested_field_append_dest_destroy_test.mko
...
if [[ "$(uname -s)" == "Linux" ]]; then
  ...
  "$mako_bin" test "$repo_dir/examples/testing/result_error_reuse_test.mko" \
    --backend c --sanitize leak
  "$mako_bin" test "$repo_dir/examples/testing/closure_lifetime_test.mko" \
    --backend c --sanitize leak
fi
set +e
