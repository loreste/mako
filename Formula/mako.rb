...
class Mako < Formula
  ...
  url "https://github.com/loreste/mako/archive/refs/tags/v0.2.2.tar.gz"
  sha256 "fd1f714959b3a858b937df4f5211b7296ccf9e023e1409e5ce2e84013d287c52"
  license "MIT"
  ...
  test do
    assert_match "mako0.2.2", shell_output("#{bin}/mako --version")
