...
class Mako < Formula
  ...
  url "https://github.com/loreste/mako/archive/refs/tags/v0.1.9.tar.gz"
  sha256 "b602639b1710c3d6154bfabc0198446a3561e9d4f41057d2d964b9d7333d940c"
  license "MIT"
  ...
  test do
    assert_match "mako0.1.9", shell_output("#{bin}/mako --version")
