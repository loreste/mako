...
Temporary filename prefixes and signal names are borrowed and reclaimed after use.
The `args()` result owns its array and strings and is reclaimed at scope exit.
