...
**Product version:** **0.5.11** (`Cargo.toml` / `mako version`);
last published tag **v0.5.11**.
...
**Train:** **0.5.11** native backend hardening: full native suite is a hard
Linux/macOS gate, and unsupported native/LLVM modes fail closed instead of
