...
**Product version:** **0.3.0** (`Cargo.toml` / `mako version` → `mako0.3.0`).  
**Published release:** [GitHub release `v0.3.0`](https://github.com/loreste/mako/releases/tag/v0.3.0).
...
```bash
curl -fsSL https://github.com/loreste/mako/releases/download/v0.3.0/install-release.sh \
  | bash -s -- --version v0.3.0 --yes
```
