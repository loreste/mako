...
**Product version:** **0.2.5** (`Cargo.toml` / `mako version` → `mako0.2.4`).  
**Published release:** [GitHub release `v0.2.4`](https://github.com/loreste/mako/releases/tag/v0.2.5).
...
```bash
curl -fsSL https://github.com/loreste/mako/releases/download/v0.2.5/install-release.sh \
  | bash -s -- --version v0.2.5 --yes
```
