...
**Product version:** **0.4.20** (`Cargo.toml` / `mako version`);
last published tag **v0.4.20**.  
**Tree status:** native compiler language gate **393/393** on
`mako test examples/testing --backend native` (2026-07-27).  
...
**Train:** **0.4.18+** hardening/security audit · **0.5.0** CLI default flip.  
