...
**Product version:** **0.5.1** (`Cargo.toml` / `mako version`);
last published tag **v0.5.1**.  
**Tree status:** native compiler language gate **395/395** on
`mako test examples/testing --backend native` (2026-07-30).  
...
**Train:** **0.5.1** DTLS + DCE fixes → **0.5.2** runtime trust.  
