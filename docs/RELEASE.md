...
**Product version:** **0.5.15** (`Cargo.toml` / `makori version`);
last published tag **v0.5.15**.
...
**Train:** **0.5.15** tooling polish: doctor, installers, release archives,
package metadata, version reporting, and normal-user CLI tools must be
