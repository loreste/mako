...
**Product version:** **0.4.17** (`Cargo.toml` / `mako version`);
last published tag **v0.4.17**.  
...
```bash
# Install v0.4.17:
curl -fsSL https://github.com/loreste/mako/releases/download/v0.4.17/install-release.sh \
  | bash -s -- --version v0.4.17 --yes
```
