...
`kick_sync_test`, wave11/14–19 queue tests, `share_atomic_test`, `chan_string_test`,
`chan_struct_test`, `fan_string_test`, `kick_string_test`). Prefer channels over shared
