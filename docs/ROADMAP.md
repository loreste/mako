...
**Landed (gap close waves 1–31):** join_timeout flatten · POD+string kick ·
reflect N + nested POD · Result/Option deep nests · nested None/Err ·
**jpeg_is_baseline_gray** · **jpeg_is_mako_jfif** · JFIF density/thumb ·
SOF0 sampling/Ci/Tqi · `jpeg_has_app7` · NLL for/if/match · more script
`\p{…}` · expanded TSan · prior work.
...
6. Complete Unicode / PCRE · JPEG viewer parity (mako JFIF shell; Huffman residual)  
7. Reflect for non-POD field types (maps/slices/chan/nested-slice/Option/Result rejected; content residual)  
