...
Last inventory: **2026-08-30** · product **mako0.6.8** (tip; release tag **v0.6.8**) ·
...
| Scope | Approx. |
|-------|---------|
| **Product version** | **0.6.8** tip · release tag **v0.6.8** ([ROADMAP.md](ROADMAP.md), [VERSIONING.md](VERSIONING.md)) |
