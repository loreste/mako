...
Last inventory: **2026-09-09** · product **mako 0.6.31** (tip; release tag **v0.6.31**) ·
...
const-fn depth (match/while/for/strings · `s[i]`) · **451** `examples/testing`
...
| Scope | Approx. |
|-------|---------|
| **Product version** | **0.6.31** tip · release tag **v0.6.31** ([ROADMAP.md](ROADMAP.md), [VERSIONING.md](VERSIONING.md)) |
