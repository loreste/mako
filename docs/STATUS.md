...
Last inventory: **2026-07-27** · product **mako0.4.17** (tip; last tag **v0.4.16**) ·
...
| Scope | Approx. |
|-------|---------|
| **Product version** | **0.4.17** tip · last tag [**v0.4.5**](https://github.com/loreste/mako/releases/tag/v0.4.5) · then **0.5.0** ([ROADMAP.md](ROADMAP.md), [VERSIONING.md](VERSIONING.md)) |
