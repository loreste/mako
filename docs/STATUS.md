...
Last inventory: **2026-08-31** · product **mako0.6.12** (tip; release tag **v0.6.12**) ·
...
| Scope | Approx. |
|-------|---------|
| **Product version** | **0.6.12** tip · release tag **v0.6.12** ([ROADMAP.md](ROADMAP.md), [VERSIONING.md](VERSIONING.md)) |
