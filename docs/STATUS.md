...
Last inventory: **2026-09-02** · product **mako0.6.24** (tip; release tag **v0.6.24**) ·
...
| Scope | Approx. |
|-------|---------|
| **Product version** | **0.6.24** tip · release tag **v0.6.24** ([ROADMAP.md](ROADMAP.md), [VERSIONING.md](VERSIONING.md)) |
