...
Last inventory: **2026-09-08** · product **mako 0.6.29** (tip; release tag **v0.6.29**) ·
...
| Scope | Approx. |
|-------|---------|
| **Product version** | **0.6.29** tip · release tag **v0.6.29** ([ROADMAP.md](ROADMAP.md), [VERSIONING.md](VERSIONING.md)) |
