...
Last inventory: **2026-09-14** · product **mako 0.6.35** (tip; release tag **v0.6.35**) ·
...
| Scope | Approx. |
|-------|---------|
| **Product version** | **0.6.35** tip · release tag **v0.6.35** ([ROADMAP.md](ROADMAP.md), [VERSIONING.md](VERSIONING.md)) |
