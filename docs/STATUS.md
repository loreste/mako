...
Last inventory: **2026-09-14** · product **mako 0.6.34** (tip; release tag **v0.6.34**) ·
...
| Scope | Approx. |
|-------|---------|
| **Product version** | **0.6.34** tip · release tag **v0.6.34** ([ROADMAP.md](ROADMAP.md), [VERSIONING.md](VERSIONING.md)) |
