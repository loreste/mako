...
Last inventory: **2026-08-15** · product **mako0.5.4** (tip; last tag **v0.5.4**) ·
...
| Scope | Approx. |
|-------|---------|
| **Product version** | **0.5.4** tip · last tag [**v0.5.4**](https://github.com/loreste/mako/releases/tag/v0.5.4) ([ROADMAP.md](ROADMAP.md), [VERSIONING.md](VERSIONING.md)) |
