...
Last inventory: **2026-09-01** · product **mako0.6.23** (tip; release tag **v0.6.23**) ·
...
| Scope | Approx. |
|-------|---------|
| **Product version** | **0.6.23** tip · release tag **v0.6.23** ([ROADMAP.md](ROADMAP.md), [VERSIONING.md](VERSIONING.md)) |
