...
These are not aspirational goals -- they are the shipped reality of Mako 0.1.7.
...
| Claim | Meaning |
|-------|---------|
| Version 0.1.7 | Current product (patch after 0.1.4); first public was 0.1.0 release, core language complete |
