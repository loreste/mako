...
These are not aspirational goals -- they are the shipped reality of Mako 0.1.8.
...
| Claim | Meaning |
|-------|---------|
| Version 0.1.8 | Current product (speed patch after 0.1.7); first public was 0.1.0 release, core language complete |
