...
**Product tip:** **0.5.4**. Patch train: **0.5.0** native-first platform, **0.5.1** toolchain/IDE,
**0.5.2** runtime trust soaks, **0.5.4** native backend completeness & memory safety.
