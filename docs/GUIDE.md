...
(script seeds: _Le/Kayah_Li/New_Tai_Lue/Ol_Chiki/Limbu/Lepcha + categories),
Huffman JPEG viewer parity (JFIF version/sampling + APP7 Mako payload today), reflect for non-POD fields
(nested POD flatten done; map/slice/Option/Result fields rejected), full SMTP AUTH-over-TLS polish, native WASI preview2 / browser DOM,
