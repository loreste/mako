...
Huffman JPEG viewer parity (mako JFIF shell + APP7 MAKOJPG today), reflect for non-POD fields
(nested POD flatten done; map/slice/chan/nested-slice/Option/Result fields rejected), full SMTP AUTH-over-TLS polish, native WASI preview2 / browser DOM,
